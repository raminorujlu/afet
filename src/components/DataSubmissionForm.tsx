      ...
      <div className="max-w-xl mx-auto py-6 px-4 md:px-6 pb-20">
        <div className="mb-6 space-y-2">
          ...
          <p className="text-muted-foreground">
            Share your experience to help us gather more accurate data on earthquake impacts.
          </p>
        </div>
        ...
        {submitted ? (
          <Card className="border border-border/60 animate-scale-in">
            <CardHeader className="bg-success-light border-b border-border/60">
              ...
              <CardDescription>
                Thank you for contributing to our earthquake data collection efforts.
              </CardDescription>
            </CardHeader>
            <CardContent className="pt-6">
              <p className="text-center text-muted-foreground mb-4">
                Your report has been successfully submitted and will help us better understand earthquake impacts in your area.
              </p>
            </CardContent>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Your email" {...field} className="form-input" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <div className="flex gap-2">
                            <FormControl>
                              <Input placeholder="City, District" {...field} className="form-input" />
                            </FormControl>
                            <Button 
                              type="button" 
                              variant="outline" 
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Latitude, Longitude" {...field} className="form-input" readOnly />
                          </FormControl>
                          <FormDescription>
                            Use the location button above to set this automatically
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input type="time" {...field} className="form-input" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-3">
                          ...
                          <FormControl>
                            ...
                            >
                              {[1, 2, 3, 4, 5].map((value) => (
                                <FormItem key={value} className="flex items-center space-x-0 space-y-0 flex-col">
                                  <FormControl>
                                    <RadioGroupItem value={value.toString()} id={`intensity-${value}`} className="sr-only" />
                                  </FormControl>
                                  <FormLabel 
                                    htmlFor={`intensity-${value}`}
                                    className={`flex flex-col items-center justify-center w-12 h-12 rounded-full cursor-pointer transition-all ${field.value === value.toString() ? 'bg-primary text-primary-foreground' : 'hover:bg-secondary'}`}
                                  >
                                    <Star className={`h-5 w-5 ${field.value === value.toString() ? 'fill-current' : 'fill-none'}`} />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Provide details about what you experienced during the earthquake
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
